...
"""
    membrane stresses shall not exceed the allowable stress value given, and any combination of membrane plus
    bending stresses shall not exceed 1.5 times the tabulated value.
"""
...
""" if __name__ == "__main__":
    ...
    params_inner = Appendix13_7_aParams(
        long_side_length_inside=0.370,
        short_side_length_inside=0.125,
        internal_pressure=0.03*10**6,
        short_side_thickness=3/1000,
        long_side_thickness=3/1000,
        allowable_stress=120*10**6,
        joint_efficiency=1
    )
